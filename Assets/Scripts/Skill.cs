...
public class Skill
{
    ...
    private void DamageLogic(Character author, Character[] party, Character[] opponents, Character target, bool absorbProc)
    {
        ...
        else
        {
            ...
            if (Logic.RNGroll(author.ricochetChance)) DamageLogic(author, party, opponents, Logic.SelectTarget(opponents), absorbProc); //this implmentation won't work as well if enemies have redirect/deflect
        }
    }
